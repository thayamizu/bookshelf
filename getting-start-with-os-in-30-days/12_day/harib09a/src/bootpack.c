...
void HariMain(void)
{
    ...
    for (;;)
    {
        ++counter;
        sprintf(s, "%d", counter);
        boxfill8(window_buf, 160, COL8_C6C6C6, 40, 28, 119, 43);
        putfont8_asc(window_buf, 160, 40, 28, COL8_000000, s);
